...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figs/so2lon} \caption{Mortalidad semanal y concentraciones de SO2 en Lobres 1952 (Bell and Davis, 2001)}\label{fig:unnamed-chunk-6}
\end{figure}

\begin{figure}
\includegraphics[width=1.2\linewidth]{figs/so2lon2} \caption{Mortalidad semanal y concentraciones de SO2 en Lobres 1952 (Bell and Davis, 2001)}\label{fig:unnamed-chunk-7}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.3\linewidth]{figs/esquema} \caption{Esquema de impacto de emisiones (Ibarra, 2017)}\label{fig:unnamed-chunk-9}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figs/800px-Synthetic_aerosol_distribution_in_number_area_and_volume_space} \caption{Distribucion normalizada (suma es 1000) de aerosoles por diametro aerodinamico, Dominio Publico}\label{fig:unnamed-chunk-10}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.5\linewidth]{figs/hotan} \caption{MP2.5 ug/m3 em Hotan, China (http://pm25.in/hetiandiqu)}\label{fig:unnamed-chunk-12}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.5\linewidth]{figs/brazil} \caption{MP2.5 ug/m3 Osasco, Brasil (https://qualar.cetesb.sp.gov.br)}\label{fig:unnamed-chunk-13}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figs/SPM1_figure-final-947x1024} \caption{Cambio en la temperatura media debido a forzantes radiativas (https://atmosphere.copernicus.eu/climate-forcing)}\label{fig:unnamed-chunk-15}
\end{figure}
...
\includegraphics[width=1.1\linewidth]{figs/fx} \textbackslash{}caption\{Forzantes indirectos (Robwood, 2019) (\url{https://atmos.uw.edu/~robwood/teaching/591/ATMS_591_Albrecht_1989.pdf})\}\label{fig:unnamed-chunk-18}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figs/bc} \caption{UNEP (https://twitter.com/UNEnvironment/status/1150404638501416961/photo/1}\label{fig:unnamed-chunk-19}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.3\linewidth]{figs/fuentes} \caption{Fuentes de emisiones}\label{fig:unnamed-chunk-20}
\end{figure}

Pueden tener aplicaciones de gestion y cientificas:

\begin{figure}
\includegraphics[width=1.5\linewidth]{figs/theart2} \caption{Tipos de inventarios (Pules and Helsinga, 2013)}\label{fig:unnamed-chunk-21}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figs/ipcc3} \caption{Serie de emisiones)}\label{fig:unnamed-chunk-23}
\end{figure}

\begin{figure}
\includegraphics[width=1.5\linewidth]{figs/ipcc4} \caption{CO2 y temperatura (http://www.ipcc.ch/report/graphics/))}\label{fig:unnamed-chunk-24}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.2\linewidth]{figs/bt} \caption{Bottom up y top-down}\label{fig:unnamed-chunk-25}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.3\linewidth]{figs/vein1} \caption{(Ibarra-Espinosa et al., 2018, https://atmoschem.github.io/vein/)}\label{fig:unnamed-chunk-27}
\end{figure}

\begin{figure}
\includegraphics[width=1.3\linewidth]{figs/vein2} \caption{(Ibarra-Espinosa et al., 2018, https://atmoschem.github.io/vein/)}\label{fig:unnamed-chunk-28}
\end{figure}
...
\begin{figure}
\includegraphics[width=1.3\linewidth]{figs/acp} \caption{(Kaiser et al., 2018)}\label{fig:unnamed-chunk-29}
\end{figure}

Columna total de NO2 en europa con Sentinel 5P libreria stars \citep{stars}

\begin{figure}
\includegraphics[width=1.5\linewidth]{figs/sentinel} \caption{STARS! Sentinel 5P}\label{fig:unnamed-chunk-30}
\end{figure}
