...
Altas concentraciones de contaminantes fueron ocurrieron entre el 5 y 9 de Diciembre de 1952 en Londres, Inglaterra. Para comparacion, vea el monumento ``Columna de Nelson'' en condiciones normales\citep{nelson1}, y el dia de la llamada``Gran Nieba de Londres''\citep{nelson2}

\begin{figure}
\centering
\includegraphics{figs/800px-Nelson's_Column,_Trafalgar_Square,_London.jpeg}
\caption{\label{fig:unnamed-chunk-4}Columna de Nelson, Dominio Publico}
\end{figure}
...
\subsection{Acidicacion de los gases escandinavos}\label{acidicacion-de-los-gases-escandinavos}}
