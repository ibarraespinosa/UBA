...
| Gas     | Razon molar $mol \cdot mol^{-1}$|
|:--------:|:------------------------------:|
|Nitrogeno ($N_2$) | 0.78 | 
|Oxigeno ($O_2$) | 0.21 | 
|Argon ($A_r$)   | 0.0093 | 
|Dioxido de carbono ($CO_2$)   | $400 \cdot10^{-6}$ | 
|Neon ($N_e$)   | $18 \cdot10^{-6}$ | 
|Ozono ($O_3$)   | $0.01-10 \cdot10^{-6}$ | 
|Helio ($H_e$)   | $5.2 \cdot10^{-6}$ | 
|Metano ($CH_4$)   | $1.8 \cdot10^{-6}$ | 
|Kripton ($K_r$)   | $1.1 \cdot10^{-6}$ | 
|Hidrogeno ($H_2$)   | $500 \cdot10^{-9}$ | 
|Oxido nitroso ($N_2O$)   | $330 \cdot10^{-9}$ | 
...
- Secundarios: formados en la atmosfera. Ejemplo: O3.
...
El Ozono luego ed fololizado a un atomo de oxigeno y una molecula de oxigeno ante radiacion menor a 1180 nm, liberando energia cinetica [@o3].
