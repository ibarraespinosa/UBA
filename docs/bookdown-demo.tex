...
\begin{longtable}[]{@{}cc@{}}
\toprule
Gas & Razon molar \(mol \cdot mol^{-1}\)\tabularnewline
\midrule
\endhead
Nitrogeno (\(N_2\)) & 0.78\tabularnewline
Oxigeno (\(O_2\)) & 0.21\tabularnewline
Argon (\(A_r\)) & 0.0093\tabularnewline
Dioxido de carbono (\(CO_2\)) & \(400 \cdot10^{-6}\)\tabularnewline
Neon (\(N_e\)) & \(18 \cdot10^{-6}\)\tabularnewline
Ozono (\(O_3\)) & \(0.01-10 \cdot10^{-6}\)\tabularnewline
Helio (\(H_e\)) & \(5.2 \cdot10^{-6}\)\tabularnewline
Metano (\(CH_4\)) & \(1.8 \cdot10^{-6}\)\tabularnewline
Kripton (\(K_r\)) & \(1.1 \cdot10^{-6}\)\tabularnewline
Hidrogeno (\(H_2\)) & \(500 \cdot10^{-9}\)\tabularnewline
Oxido nitroso (\(N_2O\)) & \(330 \cdot10^{-9}\)\tabularnewline
\bottomrule
\end{longtable}
