...
En el ultimo par de años se han publicado nuevos modelos para el calculo de emisiones, como el Vehicular Emissions Inventory model \citep{gmd} que consiste en una libreria en R

\includegraphics{figs/allcomp.gif}
...
\begin{figure}
\includegraphics[width=8.33in]{figs/acp} \caption{(Kaiser et al., 2018)}\label{fig:unnamed-chunk-28}
\end{figure}

Columna total de NO2 en europa con Sentinel 5P libreria stars \citep{stars}

\begin{figure}
\includegraphics[width=11.29in]{figs/sentinel} \caption{STARS! Sentinel 5P}\label{fig:unnamed-chunk-29}
\end{figure}
