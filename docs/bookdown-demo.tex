...
\item
  R desde Excel
\item
  Leer y procesar vectores espaciales con \textbf{sf}
\item
  Leer y procesar informacion en grillas espaciales (raster) con stars y stars
\end{itemize}
...
\hypertarget{intro}{%
\chapter{Sistemas de informacion con dartos de salud en Chile (gracias Paty Matus)}\label{intro}}
...
\textbf{\href{http://www.deis.cl/}{Departamento de Estadisticas e Informaciones de Salud}}
