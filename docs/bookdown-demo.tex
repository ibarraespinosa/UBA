...
\KeywordTok{hist}\NormalTok{(oni}\OperatorTok{$}\NormalTok{ONI, }
     \DataTypeTok{main =} \StringTok{"Histograma ONI"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-61-6.pdf}
...
\includegraphics[height=1.5\textheight]{bookdown-demo_files/figure-latex/unnamed-chunk-64-1}
